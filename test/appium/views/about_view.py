...
class PrivacyPolicyButton(BaseButton):
    def __init__(self, driver):
        ...
        self.locator = self.Locator.xpath_selector(
            '//android.view.ViewGroup[@content-desc="privacy-policy"]/android.view.ViewGroup')
...
class VersionInfo(BaseText):
    def __init__(self, driver):
        ...
        self.locator = self.Locator.xpath_selector(
            '//android.view.ViewGroup[@content-desc="version"]/android.view.ViewGroup/android.widget.TextView')
