...
function install_android_sdk_linux() {
  if [ -e ~/Android ]; then
    cecho "@b@yellow[[+ Skipping Android SDK setup- the ~/Android already exists ]]"
  else
    mkdir -p ~/Android/Sdk
    cd ~/Android/Sdk
...
function install_android_ndk_linux() {
  if [ -e ~/Android/android-ndk-r10e/ ]; then
    cecho "@b@yellow[[+ Skipping Android NDK setup- the ~/Android/android-ndk-r10e/ already exists ]]"
  else
    cd ~/Android/
