...
class StatusModule extends ReactContextBaseJavaModule implements LifecycleEventListener, ConnectorHandler {
    ...
    private String updateConfig(final JSONObject jsonConfig, final String root, final String keystoreDir) throws JSONException {
        try {
            JSONObject customConfig = new JSONObject(jsonConfig);
            ...
            if (whisperConfig != null) {
                final String dataDir = root + whisperConfig.get("DataDir");
                whisperConfig.put("DataDir", dataDir);
            }
    ...
    private void doStartNode(final String jsonConfig) {
        ...
        final String config = this.updateConfig(root, newKeystoreDir, jsonConfig);
