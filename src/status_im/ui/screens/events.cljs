...
(re-frame/reg-fx
 ...
 (fn [{:keys [title content confirm-button-text cancel-button-text on-accept on-cancel options]}]
   (utils/show-confirmation options title content confirm-button-text on-accept on-cancel cancel-button-text)))
