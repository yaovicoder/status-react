...
(defn- pin-mismatch [fx]
  (-> fx
      (assoc-in [:db :hardwallet :pin :status] :error)
      (assoc-in [:db :hardwallet :pin :error] :t/pin-mismatch)
      (assoc-in [:db :hardwallet :pin :original] [])
      (assoc-in [:db :hardwallet :pin :confirmation] [])
      (assoc-in [:db :hardwallet :pin :enter-step] :original)))
