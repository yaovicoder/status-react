...
(def writer (transit/writer :json
                            {:handlers
                             {v1.contact/NewContactKey            (NewContactKeyHandler.)
                              ...
                              v1.group-chat/GroupMembershipUpdate (GroupMembershipUpdateHandler.)}}))
                            ...
                            {:handlers
                             {"c1" (fn [[sym-key topic message]]
                              ...
                              "g5" (fn [[chat-id chat-name admin participants signature message]]
                                     (v1.group-chat/GroupMembershipUpdate. chat-id chat-name admin participants nil signature message))}})) ; removed group chat handlers for https://github.com/status-im/status-react/issues/4506
